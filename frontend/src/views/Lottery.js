        ...
        <div className="flex flex-col md:flex-row space-y-4 md:space-x-4 mb-8">
          ...
          flex flex-col w-full md:w-1/3 space-y-4  rounded-default py-4 px-8">
            ...
            <div className="flex flex-row space-x-4">
              ...
              <Typography type="span" className="font-medium text-yellow-300">#{nextDrawNumber} | {nextDrawDate}</Typography>
            </div>

            <div className="flex flex-row space-x-4">
              <Typography type="span" className="font-medium text-white">Total Price Pot</Typography>
              <Typography type="span" className="font-medium text-yellow-300">{currentPricePot} LSK</Typography>
            </div>
          ...
          flex flex-col w-full md:w-1/3 space-y-4  rounded-default py-4 px-8">
            <div className="flex flex-row space-x-4 text-24px">
              <Typography type="span" type="span" className="font-bold text-white">Round #{nextDrawNumber} | {nextDrawDate}</Typography>
            </div>
          ...
          <div className="w-full md:w-1/4 mx-auto flex flex-col">
            <div className="flex w-full flex-row space-x-4">
              <div className="flex w-full flex-col  space-y-4 bg-gradient-to-r from-indigo-600  to-indigo-800 rounded-default p-4">
                <div className="flex flex-col space-y-2">
